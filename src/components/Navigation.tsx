...
const socialItems: SocialItem[] = [
  { label: "GitHub", href: "https://github.com/virtuousloom" },
  { label: "LinkedIn", href: "https://www.linkedin.com/company/virtuousloom" },
  { label: "Instagram", href: "https://www.instagram.com/virtuousloom" },
  { label: "Email", href: "mailto:hello@virtuousloom.com" },
];
...
const Navigation = () => {
  ...
  return (
    <>
      {/* Logo — top left */}
      <div className="fixed top-6 left-6 md:top-8 md:left-10 z-[200] mix-blend-difference">
